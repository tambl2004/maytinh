        ...
        <div class="related-products">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="position-relative overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1593642702821-c8da6771f0c6?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" 
                                 alt="Dell XPS 15" class="product-image">
                        ...
                        <div class="p-3">
                            <h6 class="fw-bold">Dell XPS 15 (9530)</h6>
                            <p class="text-muted small mb-2">Intel Core i7-13700H | RTX 4060</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <span class="price">45.990.000₫</span>
                                    <br>
                                    <span class="old-price small">49.990.000₫</span>
                                </div>
                                <button class="btn btn-custom btn-sm">Xem chi tiết</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="position-relative overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1541807084-5c52b6b3adef?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" 
                                 alt="MacBook Air M2" class="product-image">
                            <div class="position-absolute top-0 end-0 m-3">
                                <button class="btn btn-light btn-sm rounded-circle">
                                    <i class="far fa-heart"></i>
                                </button>
                        ...
                        <div class="p-3">
                            <h6 class="fw-bold">MacBook Air M2 13"</h6>
                            <p class="text-muted small mb-2">Apple M2 | 8GB | 256GB SSD</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="position-relative overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1525547719571-a2d4ac8945e2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" 
                                 alt="HP Spectre x360" class="product-image">
                            <div class="position-absolute top-0 end-0 m-3">
                                <button class="btn btn-light btn-sm rounded-circle">
                                    <i class="far fa-heart"></i>
                                </button>
                        ...
                        <div class="p-3">
                            <h6 class="fw-bold">HP Spectre x360 14"</h6>
                            <p class="text-muted small mb-2">Intel Core i7-1355U | 16GB RAM</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <span class="price">36.990.000₫</span>
                                    <br>
                                    <span class="old-price small">39.990.000₫</span>
                                </div>
                                <button class="btn btn-custom btn-sm">Xem chi tiết</button>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="position-relative overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1593642634367-d91a135587b5?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" 
                                 alt="Lenovo ThinkPad X1" class="product-image">
                            <div class="position-absolute top-0 end-0 m-3">
                                <button class="btn btn-light btn-sm rounded-circle">
                                    <i class="far fa-heart"></i>
                                </button>
                        ...
                        <div class="p-3">
                            <h6 class="fw-bold">Lenovo ThinkPad X1 Carbon</h6>
                            <p class="text-muted small mb-2">Intel Core i7-1365U | 16GB RAM</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
